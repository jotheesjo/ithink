...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">EDIT CORPORATE INFO</h4>
                    </div>
                </div>
                <!-- ============================================================== -->
                        ...
                        echo '<br/><p style="color:#ff0000">'.$_GET['msg'].'</p>';
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <select class="form-control" placeholder="Department" name="department" required>
                                                ...
                                                <option value="<?=$deprow['department_id'];?>" <?php if($emp_list['emp_department']==$deprow['department_id']){ echo " selected"; }?>><?=$deprow['department_name'];?></option>
                                                <?php }?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mobile" class="form-control onlynumber" maxlength="10" minlength="10" placeholder="Mobile" name="mobile" required value="<?=$emp_list['emp_mobile'];?>">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="alternate mobile" class="form-control onlynumber" maxlength="10" minlength="10" placeholder="Alternate Mobile" name="altr_mobile" required value="<?=$emp_list['emp_altr_mobile'];?>">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
    ...
    echo '<option '.$sel.' value='.$state_row['id'].'>'.$state_row['name'].'</option>'; } ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control onlynumber" maxlength="6" minlength="6" name="postcode" required value="<?=$emp_list['emp_pincode'];?>">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="password" class="form-control" placeholder="password" name="password" required  value="<?=base64_decode($emp_list['emp_password']);?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="emp_role" id="role" required>
                                                ...
                                                <option value="super admin" <?php if($emp_list['emp_role']=="super admin"){ echo " selected";}?>>Super Admin</option>
                                                <option value="manager" <?php if($emp_list['emp_role']=="manager"){ echo " selected";}?>>Manager</option>
                                                <option value="employee" <?php if($emp_list['emp_role']=="employee"){ echo " selected";}?>>Employee</option>
                                            </select>
                                        </div>
                                    </div>
                                        </div>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="update_corporate"> <i class="fa fa-check"></i> Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
