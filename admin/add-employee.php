...
?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mobile" class="form-control form-control" placeholder="Mobile" name="mobile" required>
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="alternate mobile" class="form-control" placeholder="Alternate Mobile" name="altr_mobile" required>
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-4">
    ...
    echo '<option '.$sel.' value='.$state_row['id'].'>'.$state_row['name'].'</option>'; } ?>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="insert_employee"> <i class="fa fa-check"></i> Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
