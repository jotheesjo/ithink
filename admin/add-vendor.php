...
?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="GST" class="form-control" placeholder="GST Number" name="gst" required>
                                                    </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
    ...
    echo '<option '.$sel.' value='.$state_row['id'].'>'.$state_row['name'].'</option>'; } ?>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="insert_vendor"> <i class="fa fa-check"></i> Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
