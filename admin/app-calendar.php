<?php include("header.php");
 include("aside.php"); 
$qry=mysqli_query($conn,"SELECT * FROM appoinment");
$data_cnt=mysqli_num_rows($qry);
if($data_cnt>0){
    $caldata="";
   while($row=mysqli_fetch_array($qry)){
       $mdate=strtotime($row['app_date'])* 1000;
       if($row['app_status']=="1"){
           $className="className: 'bg-success'";
       }elseif($row['app_status']=="0"){
