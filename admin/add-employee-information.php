...
?>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstName" class="form-control" placeholder="Employee code" name="employee_code" required>
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="emergency mobile" class="form-control onlynumber" maxlength="10" minlength="10" placeholder="Emergency Mobile" name="emergency_mobile" required>
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="appdate" class="form-control date-format2" placeholder="Date of Birth" name="dob" required>
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Date of Join</label>
                                                    <input type="text" id="doj" class="form-control date-format2" placeholder="Date of Join" name="doj" required>
                                                    </div>
                                            </div>
    ...
    echo '<option '.$sel.' value='.$state_row['id'].'>'.$state_row['name'].'</option>'; } ?>
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success" name="insert_employees"> <i class="fa fa-check"></i> Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
